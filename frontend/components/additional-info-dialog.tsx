...
import { POPULAR_ROOM_LIMIT, ROOM_POPULARITY_DAYS } from '@/lib/popularity';
        ...
        <div className="additional-info-sections">
          <section>
            ...
            <p>
              ...
              востребованные пространства остаются доступны. У преподавателя
              рейтинг не ограничивает бронирование.
            </p>
          </section>
          <section>
            <h3>
            ...
            <p>
              Каждая успешная бронь добавляет выбранному коворкингу 1 скрытый
              балл на {ROOM_POPULARITY_DAYS} дней. Система использует эти баллы,
              чтобы определить {POPULAR_ROOM_LIMIT} самых востребованных
              пространств.
            </p>
            <p>
              Правило действует автоматически: рейтинг влияет на доступ к топ-
              {POPULAR_ROOM_LIMIT}, а не на возможность пользоваться сервисом
              полностью.
            </p>
          </section>
          <section>
